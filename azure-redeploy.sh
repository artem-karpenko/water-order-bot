...
EMAIL_ORDER_SUBJECT=${EMAIL_ORDER_SUBJECT:-"Water Delivery Order"}
EMAIL_ORDER_BODY=${EMAIL_ORDER_BODY:-"Please deliver water."}
...
sed -e "s/REGISTRY_PASSWORD_PLACEHOLDER/${AZURE_REGISTRY_PASSWORD}/g" \
    ...
    -e "s/EMAIL_ORDER_SUBJECT_PLACEHOLDER/${EMAIL_ORDER_SUBJECT}/g" \
    -e "s/EMAIL_ORDER_BODY_PLACEHOLDER/${EMAIL_ORDER_BODY}/g" \
    -e "s|AZURE_STORAGE_CONNECTION_STRING_PLACEHOLDER|${AZURE_STORAGE_CONNECTION_STRING}|g" \
